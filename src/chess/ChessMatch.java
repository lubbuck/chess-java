...
public class ChessMatch {
	...
	private Piece makeMove(Position source, Position target) {
		...
		if (sourcePiece instanceof King && target.getColumn() == source.getColumn() + 2) {
			Position rightRookPosition = new Position(source.getRow(), source.getColumn() + 3);
			Position rookTarget = new Position(source.getRow(), source.getColumn() + 1);
			ChessPiece rook = (ChessPiece) board.removePiece(rightRookPosition);
		...
		// big rooking
		if (sourcePiece instanceof King && target.getColumn() == source.getColumn() - 2) {
			Position rightRookPosition = new Position(source.getRow(), source.getColumn() - 4);
			Position rookTarget = new Position(source.getRow(), source.getColumn() - 1);
			ChessPiece rook = (ChessPiece) board.removePiece(rightRookPosition);
			board.placePiece(rook, rookTarget);
			rook.increaseMoveCount();
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		if (piece instanceof King && target.getColumn() == source.getColumn() + 2) {
			...
			board.placePiece(rook, rightRookPosition);
